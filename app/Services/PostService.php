...
class PostService
{
    ...
    public function getPostInfo()
    {
        ...
        $url = "https://graph.facebook.com/v19.0/me/feed?fields=id,created_time,from,is_expired,parent_id,is_popular,timeline_visibility,promotion_status,is_hidden,is_published,updated_time&access_token=" . $this->pageAccessToken;
