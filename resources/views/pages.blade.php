    ...
    <style>
        ...
        .page-link {
            ...
            /* Light gray background for links */
            padding: 0.5rem 1rem;
            /* Adjusted padding for links */
            border-radius: 0.25rem;
            /* Rounded corners for links */
            margin-bottom: 0.5rem;
            /* Spacing between links and text */
            margin-right: 0.5rem;
        }
        ...
        .page-link:hover {
            ...
            /* Adjusted hover background color (muted blue) */
        }
        ...
        .category-badge {
            ...
            /* Muted background for category */
            color: #6b7280;
            /* Muted text color for category */
            margin-right: 0.5rem;
        }
    ...
    <x-app-layout>
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2" id="pagesContainer">
                    @foreach ($pages as $page)
                        <div class="page-card bg-white rounded-lg shadow-md p-2 relative overflow-hidden">
                            <div class="relative mb-4">
                                <img src="{{ $page->cover_picture_url }}" alt="Cover photo of {{ $page->name_page }}"
                                    class="w-full h-40 object-cover rounded-t-lg">
                                <div
                                    class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-black opacity-40">
                                </div>
                                <div class="absolute top-0 right-0 mt-4 mr-4 flex justify-center items-center">
                                    <div
                                        class="relative w-16 h-16 rounded-full overflow-hidden shadow-lg border-4 border-white">
                                        <img src="{{ $page->picture_url }}" alt="Photo of {{ $page->name_page }}"
                                            class="mx-auto rounded-full w-full h-full object-cover">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-gray-700 dark:text-gray-300"><strong>About:</strong> {{ $page->about }}
                                </p>
                                <p class="text-gray-700 dark:text-gray-300"><strong>Location:</strong>
                                    {{ $page->location }}
                                </p>
                                <p class="text-gray-700 dark:text-gray-300"><strong>Created:</strong>
                                    {{ $page->created_at->format('Y-m-d') }}</p>
                                <p class="text-gray-700 dark:text-gray-300"><strong>Category:</strong>
                                    {{ $page->categorie }}</p>
                            </div>
