    ...
    <style>
        ...
        .card {
            width: 290px; /* Set a fixed width for all cards */
            height: 125px; /* Set a fixed height for all cards */
        ...
        .card-header::after {
            ...
            width: 100%;
            height: 1px;
            background-color: #f44e57; /* Line color */
        }
        ...
        .tooltip {
            width: 220px;
            background-color: #fbf7f7 !important; /* Tooltip background color */
            color: #652525 !important; /* Tooltip text color */
            text-align: center;
            border-radius: 6px;
            padding: 5px 10px;
            position: absolute;
...
<x-app-layout>
    <div class="container">
        ...
        <div class="post-cards">
            ...
            <!-- Post Clicks Card -->
            <div class="card" title="The number of clicks anywhere in your post on News Feed from the user that matched the audience targeting on it.">
        ...
        @endif
            ...
            <div class="card" title="The number of people who have liked your Page and clicked anywhere in your posts.">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const reactionCounts = [{{ $reactionTotals['like'] }}, {{ $reactionTotals['love'] }}, {{ $reactionTotals['wow'] }},{{ $reactionTotals['haha'] }} ,{{ $reactionTotals['sorry'] }},{{ $reactionTotals['anger'] }} ]; // Sample data, replace with your actual counts
            ...
            const pieChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: percentages,
                        backgroundColor: ['#1877f2', '#f02849', '#fbbc05', '#ff7e29', '#ea4c89', '#ed4242'], // Facebook colors
                    }]
                },
                options: {
                    legend: {
