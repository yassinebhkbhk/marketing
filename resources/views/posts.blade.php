...
<head>
  ...
  <style>
    ...
    img.post-picture {
      ...
      margin-bottom: 1rem; /* Add border-radius for rounded corners */
    }
  </style>
</head>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div class="post-container bg-white rounded-lg shadow-md p-6">
        <div class="border-b border-gray-200 mb-4 pb-4">
          ...
          <p class="text-gray-700 dark:text-gray-300">Created Time: {{ \Carbon\Carbon::parse($post->created_time)->isoFormat('MMMM Do YYYY, h:mm:ss a') }}</p>
        ...
        @if ($post->type == 'mobile_status_update')
          @if (isset($post->picture_url))
            <div class="mb-4">
              ...
              <p class="text-gray-700 dark:text-gray-300"> {{$post->message}}</p> <!-- Added message here -->
            </div>
          @else
            <div class="mb-4">
