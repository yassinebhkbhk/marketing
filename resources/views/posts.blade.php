                            ...
                            <div class="post-container bg-white rounded-lg shadow-md p-6">
                                ...
                                <div class="pro-logo-container">
                                    ...
                                    @if ($post->type == 'mobile_status_update')
                                        <p class="text-gray-700 dark:text-gray-300 impressions">Type: Status</p>
                                    @elseif ($post->type == 'added_video')
                                        <p class="text-gray-700 dark:text-gray-300 impressions">Type: Video</p>
                                    @elseif ($post->type == 'added_photos')
                                        <p class="text-gray-700 dark:text-gray-300 impressions">Type: Picture</p>
                                    @endif
                                </div>
                                @if ($post->type == 'mobile_status_update')
